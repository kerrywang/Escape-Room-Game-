...
MyEscapeRoom-Linux-Debug:
	 $(PROJECTBUILD) MyEscapeRoom Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoom-Linux-DebugGame:
	 $(PROJECTBUILD) MyEscapeRoom Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoom-Linux-Shipping:
	 $(PROJECTBUILD) MyEscapeRoom Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoom-Linux-Test:
	 $(PROJECTBUILD) MyEscapeRoom Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoom:
	 $(PROJECTBUILD) MyEscapeRoom Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoomEditor-Linux-Debug:
	 $(PROJECTBUILD) MyEscapeRoomEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoomEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MyEscapeRoomEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoomEditor-Linux-Shipping:
	 $(PROJECTBUILD) MyEscapeRoomEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoomEditor-Linux-Test:
	 $(PROJECTBUILD) MyEscapeRoomEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyEscapeRoomEditor:
	 $(PROJECTBUILD) MyEscapeRoomEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
