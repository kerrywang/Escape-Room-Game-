...
unrealRootPath=/home/kaiyuewang/UnrealEngine
MyEscapeRoomRootPath=/home/kaiyuewang/Downloads/unreal_project/BuildingEscape/MyEscapeRoom

gameProjectFile=/home/kaiyuewang/Downloads/unreal_project/BuildingEscape/MyEscapeRoom/MyEscapeRoom.uproject
...
include(MyEscapeRoomSource.pri)
include(MyEscapeRoomHeader.pri)
include(MyEscapeRoomConfig.pri)
include(MyEscapeRoomIncludes.pri)
include(MyEscapeRoomDefines.pri)

MyEscapeRoom-Linux-Debug.commands = $$build MyEscapeRoom Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoom-Linux-DebugGame.commands = $$build MyEscapeRoom Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoom-Linux-Shipping.commands = $$build MyEscapeRoom Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoom-Linux-Test.commands = $$build MyEscapeRoom Linux Test  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoom.commands = $$build MyEscapeRoom Linux Development  -project="\"$$gameProjectFile\"" $$args

MyEscapeRoomEditor-Linux-Debug.commands = $$build MyEscapeRoomEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoomEditor-Linux-DebugGame.commands = $$build MyEscapeRoomEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoomEditor-Linux-Shipping.commands = $$build MyEscapeRoomEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoomEditor-Linux-Test.commands = $$build MyEscapeRoomEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MyEscapeRoomEditor.commands = $$build MyEscapeRoomEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	MyEscapeRoom-Linux-Debug \
	MyEscapeRoom-Linux-DebugGame \
	MyEscapeRoom-Linux-Shipping \
	MyEscapeRoom-Linux-Test \
	MyEscapeRoom \
	MyEscapeRoomEditor-Linux-Debug \
	MyEscapeRoomEditor-Linux-DebugGame \
	MyEscapeRoomEditor-Linux-Shipping \
	MyEscapeRoomEditor-Linux-Test \
	MyEscapeRoomEditor \
